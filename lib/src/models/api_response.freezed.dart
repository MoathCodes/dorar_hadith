...
/// The actual data returned by the API
 T get data;/// Metadata about the response (pagination, caching, etc.)
...
@useResult
$Res call({
 T data, SearchMetadata metadata
});
...
$SearchMetadataCopyWith<$Res> get metadata {
  ...
  return $SearchMetadataCopyWith<$Res>(_self.metadata, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( T data,  SearchMetadata metadata)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ApiResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( T data,  SearchMetadata metadata)  $default,) {final _that = this;
switch (_that) {
case _ApiResponse():
return $default(_that.data,_that.metadata);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( T data,  SearchMetadata metadata)?  $default,) {final _that = this;
switch (_that) {
case _ApiResponse() when $default != null:
return $default(_that.data,_that.metadata);case _:
  return null;
...
class _ApiResponse<T> implements ApiResponse<T> {
  const _ApiResponse({required this.data, required this.metadata});
...
@override final  SearchMetadata metadata;
...
@override $SearchMetadataCopyWith<$Res> get metadata;
...
/// Create a copy of ApiResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? data = freezed,Object? metadata = null,}) {
